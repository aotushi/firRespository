          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="mins" @click="skuNum=skuNum--<=1?1:skuNum">-</a>
              </div>
              <div class="add">
...
import { mapGetters, mapState } from 'vuex'
  ...
  export default {
    ...
    methods:{
      ...
      // 测试: 商品属性 点击更改颜色,通过点击索引和当下索引值是否相等来比较
      changeColor(spuSaleAttrValue, spuSaleAttrValueList){
        // 排它第一步:全部一样(item身上的isChecked有0和1两个值)
