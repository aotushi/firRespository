<template>
    <div class="pagination">
        <button :disabled="currentPageNo === 1" @click="$emit('changePage', currentPageNo-1)">上一页</button>
        ...
        <button :disabled="currentPageNo === totalPageNo" @click="$emit('changePage',currentPageNo+1)">下一页</button>
